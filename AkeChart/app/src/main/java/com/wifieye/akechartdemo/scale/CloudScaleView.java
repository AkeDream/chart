...
public class CloudScaleView extends View {
    ...
    public CloudScaleView(Context context) {
        this(context, null);
    }

    public CloudScaleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CloudScaleView(Context context, AttributeSet attrs, int defStyleAttr) {
